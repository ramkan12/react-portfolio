  ...
  return (
    <Reveal direction="up">
      <TerminalWindow file={project.file} className="shadow-2xl shadow-black/40 ring-1 ring-term-green/30">
        ...
        <p className="mt-5 leading-relaxed text-term-muted">{project.teaser}</p>
            ...
            >
              <div className="flex flex-col gap-4 pt-4">
                {project.fullDescription.map((paragraph) => (
                  <p key={paragraph.slice(0, 24)} className="leading-relaxed text-term-muted">
                    {paragraph}
                  </p>
                ))}
              </div>
        ...
        <button
          ...
          className="mt-4 rounded font-mono text-sm text-term-green transition-colors hover:text-term-cyan focus:outline-none focus-visible:ring-2 focus-visible:ring-term-green focus-visible:ring-offset-2 focus-visible:ring-offset-term-panel"
        >
